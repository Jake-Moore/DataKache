    ...
    init {
        describe("Cache Size Operations") {
            ...
            it("should verify cache size increases after creating documents") {
                ...
                cache
                    .create("cacheSizeIncreaseKey1") { doc ->
                ...
                cache
                    .create("cacheSizeIncreaseKey2") { doc ->
                ...
                cache
                    .create("cacheSizeIncreaseKey3") { doc ->
            ...
            it("should verify cache size with documents having complex data") {
                ...
                cache
                    .create("cacheSizeComplexKey1") { doc ->
                        doc.copy(
                ...
                cache
                    .create("cacheSizeComplexKey2") { doc ->
                        doc.copy(
            ...
            it("should verify cache size consistency with readAll") {
                ...
                // Create multiple documents
                cache
                    .create("cacheSizeConsistencyKey1") { doc ->
                        doc.copy(name = "Consistency Doc 1", balance = 100.0)
                    }.getOrThrow()

                cache
                    .create("cacheSizeConsistencyKey2") { doc ->
                        doc.copy(name = "Consistency Doc 2", balance = 200.0)
                    }.getOrThrow()

                cache
                    .create("cacheSizeConsistencyKey3") { doc ->
            ...
            it("should verify cache size consistency with getKeys") {
                ...
                // Create multiple documents
                cache
                    .create("cacheSizeKeysConsistencyKey1") { doc ->
                        doc.copy(name = "Keys Consistency Doc 1", balance = 100.0)
                    }.getOrThrow()

                cache
                    .create("cacheSizeKeysConsistencyKey2") { doc ->
            ...
            it("should verify cache size with readOrCreate operations") {
                ...
                cache
                    .readOrCreate("readOrCreateKey1") { doc ->
                ...
                // Create another document
                cache
                    .readOrCreate("readOrCreateKey2") { doc ->
